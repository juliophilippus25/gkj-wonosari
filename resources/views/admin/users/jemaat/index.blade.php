                                        ...
                                        <td>
                                            @if ($jemaat->is_verified == 0)
                                                @if (Auth::user()->role == 'admin')
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="verifyModal{{ $jemaat->id }}"
                                                        tabindex="-1" aria-labelledby="verifyModalLabel{{ $jemaat->id }}"
                                                        aria-hidden="true">
                                            ...
                                            @elseif ($jemaat->is_verified == 1)
                                                @if (Auth::user()->role == 'admin')
                                                    ...
                                                    <div class="modal fade" id="detailModal{{ $jemaat->id }}"
                                                        tabindex="-1" aria-labelledby="verificationModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
