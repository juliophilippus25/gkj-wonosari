        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="input-group mb-3"> <input id="password" name="password" type="password"
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="d-grid gap-2"> <button type="submit" class="btn btn-primary">Sign Up</button>
                            </div>
                        </div> <!-- /.col -->
                    </div> <!--end::Row-->
                </form>
