...
@section('title', 'Pelayanan Sidhi/sidhi Dewasa')
...
@section('content')
    ...
    <div class="app-content"> <!--begin::Container-->
        <div class="container-fluid"> <!-- Small Box (Stat card) -->
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form
                                                                action="{{ route('sidhi.pendeta.accept', $pendaftar->id) }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <!-- Form Catatan Tolak -->
                                                            <form
                                                                action="{{ route('sidhi.pendeta.reject', $pendaftar->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <label for="catatan"
            ...
            <a href="{{ route('sidhi.pendeta.index') }}" class="btn btn-secondary mt-4">Kembali</a>
